      ...
      <details>
        <summary>
          <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7768&branchName=master">
            <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rb-msgpack-feedstock?branchName=master">
          </a>
        </summary>
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7768&branchName=master">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rb-msgpack-feedstock?branchName=master&jobName=linux&configuration=linux_ruby2.5" alt="variant">
                </a>
              </td>
            </tr><tr>
              <td>linux_ruby2.6</td>
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7768&branchName=master">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rb-msgpack-feedstock?branchName=master&jobName=linux&configuration=linux_ruby2.6" alt="variant">
                </a>
              </td>
            </tr><tr>
              <td>osx_ruby2.5</td>
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7768&branchName=master">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rb-msgpack-feedstock?branchName=master&jobName=osx&configuration=osx_ruby2.5" alt="variant">
                </a>
              </td>
            </tr><tr>
              <td>osx_ruby2.6</td>
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7768&branchName=master">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rb-msgpack-feedstock?branchName=master&jobName=osx&configuration=osx_ruby2.6" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
Once the `conda-forge` channel has been enabled, `rb-msgpack` can be installed with:

```
conda install rb-msgpack
```

It is possible to list all of the versions of `rb-msgpack` available on your platform with:
